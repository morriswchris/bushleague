...
var leagues = ["nfl", "nba", "mlb", "mls", "nhl", "wjhc", "cfl", "ncaaf", "ncaab", "uefa", "chlg", "epl", "bund", "liga", "seri", "fran"];
var league = yargs.l || yargs.league;
if(leagues.indexOf(league) < 0){
  console.log("Only the following leagues are available:");
  console.log(leagues.toString().replace(/,/g, " "));
  return;
}
